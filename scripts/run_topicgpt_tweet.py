"""
Run TopicGPT pipeline on tweet_topic dataset.

Usage: python scripts/run_topicgpt_tweet.py
Must be run from the project root: /home/toolkit/LLM-Topic-Modeling
"""
...
def load_config():
    with open("config_tweet_topic.yml", "r") as f:
...
def run_assignment(config):
    print("\n" + "=" * 60)
    print("STEP 3: Topic Assignment (full dataset)")
    print("=" * 60)
