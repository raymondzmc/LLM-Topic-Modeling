...
import torch
import numpy as np
from models.octis.etm.data import get_batch
from sklearn.feature_extraction.text import CountVectorizer
from models.octis.etm.model import ETM as ETMModel
from models.octis.etm.abc import BaseETM
...
class ETM(BaseETM):
    ...
    def inference(self):
        ...
        for idx, ind in enumerate(indices):
            data_batch = get_batch(self.test_tokens, self.test_counts,
