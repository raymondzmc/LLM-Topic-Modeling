...
from models.topmost.ECRTM.ECR import ECR


class GenerativeECRTMModel(nn.Module):
...
class GenerativeECRTM:
    """Trainer for GenerativeECRTMModel using CTMDataset (LLM embeddings + logits)."""
    ...
    def __init__(self, vocab_size, embedding_size, num_topics=25, vocab=None,
        ...
        self.model = GenerativeECRTMModel(
    ...
    def fit(self, ctm_dataset):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            if epoch % 10 == 0 or epoch == 1:
                print(f'GenerativeECRTM Epoch: {epoch:03d} loss: {loss_accum / n_total:.3f}')
