...
class GenerativeETMModel(nn.Module):
...
class GenerativeETM:
    """Trainer for GenerativeETMModel using CTMDataset (LLM embeddings + logits)."""
    ...
    def fit(self, ctm_dataset):
        ...
        for epoch in range(self.num_epochs):
            ...
            if (epoch + 1) % 10 == 0 or epoch == 0:
                print(f'GenerativeETM Epoch [{epoch+1}/{self.num_epochs}] Loss: {total_loss/n:.4f}')
