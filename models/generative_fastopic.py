...
from models.fastopic._fastopic import fastopic
from models.fastopic._utils import get_top_words
from models.fastopic._model_utils import pairwise_euclidean_distance


class GenerativeFASTopicModel(fastopic):
...
class GenerativeFASTopic:
    """Trainer for GenerativeFASTopicModel using CTMDataset (LLM embeddings + logits).
    ...
    def __init__(self, vocab_size, embedding_size, num_topics=25,
        ...
        self.model = GenerativeFASTopicModel(
    ...
    def fit(self, ctm_dataset):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            if epoch % 10 == 0 or epoch == 1:
                print(f'GenerativeFASTopic Epoch: {epoch:03d} loss: {loss.item() / n_total:.3f}')
