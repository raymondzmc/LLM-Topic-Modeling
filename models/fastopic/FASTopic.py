...
from models.fastopic import _plot
from models.fastopic import _fastopic
from models.fastopic._utils import Logger, assert_fitted, check_fitted, DocEmbedModel, Dataset, get_top_words
...
class FASTopic:
    def __init__(
        ...
        self.model = _fastopic.fastopic(num_topics, theta_temp, DT_alpha, TW_alpha)
